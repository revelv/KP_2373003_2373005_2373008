...
<body>
    <div class="container_cart mt-4">
        ...
        <?php if ($result && mysqli_num_rows($result) > 0): ?>
            <form action="payment.php" method="POST" id="cart-form">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td>
                                    <input type="checkbox" class="item-checkbox" name="selected_items[]" value="<?= $row['cart_id']; ?>" 
                                           data-price="<?= $harga_numerik; ?>" data-quantity="<?= $row['jumlah_barang']; ?>" checked>
                                </td>
                    ...
                    <tfoot>
                        <tr class="table-group-divider fw-bold">
                            ...
                            <th colspan="2" id="cart-total-display" data-voucher-discount="<?= $voucher_discount; ?>">
            ...
            </form> <div class="row mt-4 align-items-center">
                <div class="col-md-6">
                ...
                <div class="col-md-6 text-end">
                    <button type="submit" name="proceed_payment" class="btn btn-success" form="cart-form">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const voucherCode = "<?= $voucher_code ? htmlspecialchars($voucher_code) : ''; ?>";
            ...
            function updateTotalPrice() {
                ...
                if (voucherDiscount > 0) {
                    totalHTML += `<br><small style="font-weight:normal; color: #28a745;">(Savings: ${formatRupiah(voucherDiscount)})</small>`;
                }
