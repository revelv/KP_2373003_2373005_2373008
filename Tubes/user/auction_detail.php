...
// Ambil data lelang
$query_auc = "
    SELECT a.*, c.nama as seller_name, w.nama as winner_name
    FROM auctions a
...
<head>
    ...
    <style>
        .auction-image-detail { max-height: 500px; width: 100%; object-fit: cover; border-radius: 8px; }
        .bid-box { background-color: #f8f9fa; padding: 20px; border-radius: 8px; }
        .countdown-timer-detail { font-size: 1.5rem; font-weight: bold; color: var(--gold); }
    </style>
</head>
<body>
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-lg-5">
                ...
                <p class="text-muted">Dilelang oleh: <?= htmlspecialchars($auction['seller_name']); ?></p>
                ...
                <div class="bid-box">
                    <?php if ($auction['status'] == 'active' && strtotime($auction['end_time']) > time()): ?>
                        ...
                        <?php if (isset($_SESSION['alert'])): ?>
                            <div class="alert alert-danger"><?= $_SESSION['alert']; unset($_SESSION['alert']); ?></div>
                        <?php endif; ?>
