...
<head>
    ...
    <style>
        .floating-wa { position: fixed; bottom: 25px; right: 25px; background-color: #25D366; color: white; width: 60px; height: 60px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 30px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.2); z-index: 1000; transition: transform 0.2s ease; }
        .floating-wa:hover { transform: scale(1.1); }
        .login-form { padding: 1rem 1.25rem; min-width: 250px; }
    ...
    <div class="container_header">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0" style="gap: 1rem;">
                ...
                <li class="nav-item"><a class="nav-link" href="./HOME/index.php#about">About Us</a></li>
