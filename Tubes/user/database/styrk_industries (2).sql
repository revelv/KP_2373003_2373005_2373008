...
--
-- Host: localhost:3306
-- Waktu pembuatan: 15 Nov 2025 pada 14.10
-- Versi server: 8.4.3
-- Versi PHP: 8.3.16
...
(4, 16, 'KB017', 'Akko MOD 007 V2', 'A premium 75% keyboard with gasket mount design.', 'https://i.postimg.cc/QCfr0C2j/40.jpg', 2000000.00, 2000000.00, NULL, '2025-11-15 10:03:48', '2025-11-17 10:03:00', 'active'),
...
CREATE TABLE `products` (
  ...
  `weight` int NOT NULL,
  `status_jual` enum('dijual','dilelang') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'dijual'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `bids`
  MODIFY `bid_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
