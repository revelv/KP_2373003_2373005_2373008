...
INSERT INTO `orders` (`order_id`, `customer_id`, `tgl_order`, `provinsi`, `kota`, `alamat`, `komship_order_no`, `komship_awb`, `komship_status`, `komship_last_sync`, `code_courier`, `ongkos_kirim`, `total_harga`) VALUES
